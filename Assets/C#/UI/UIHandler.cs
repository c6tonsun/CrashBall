...
public class UIHandler : MonoBehaviour {
    ...
    private TextMeshPro[] _positionFeeds;
    ...
    public void FadeOutFeeds()
    {
        foreach (TextMeshPro feed in _positionFeeds)
        {
            if (feed.GetComponent<UIFadeOut>())
                feed.GetComponent<UIFadeOut>().enabled = true;
            else
                feed.gameObject.AddComponent<UIFadeOut>();
        }

        foreach (TextMeshPro feed in _killFeeds)
        {
            if (feed.GetComponent<UIFadeOut>())
                feed.GetComponent<UIFadeOut>().enabled = true;
            else
        ...
        startFeed.GetComponent<UIFadeOut>().enabled = true;
        endFeed.gameObject.AddComponent<UIFadeOut>();
    }
}
